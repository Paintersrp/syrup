import { TableCell, TableHead, TableRow, TableSortCell } from '@/components/Elements';
    ...
    <TableHead>
      <TableRow>
        <TableCell a="center" style={{ width: '3%', minWidth: 35 }}>
          <Checkbox checked={selectedItems.length === data.length} onChange={toggleSelectAll} />
        </TableCell>
          ...
          <React.Fragment key={key}>
            <TableCell a="center" fw={800}>
              <TableSortCell
                ...
                label={
                  metadata[key].verbose_name === 'image' ? 'Thumbnail' : metadata[key].verbose_name
                }
              />
            </TableCell>
        ...
        <TableCell a="center" fw="bold">
          {model.model_name === 'messages' || model.model_name === 'application' ? 'Read' : 'Edit'}
        </TableCell>
        <TableCell a="center" fw="bold">
          Delete
        </TableCell>
