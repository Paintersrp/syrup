...
import { sequelize, NotFoundError } from '../../lib';
...
export class Root extends Model {
   ...
   */
  static verbose = 'BaseModel';

  /**
   * Internal function for input validation.
   * @param input - The input data to validate.
   */
  static validateFn: (input: any) => void;
...
Root.init(modelAttributes, modelOptions);
