/**
 * @description
 * Returns the template for generating a LayoutProvider file in the providers directory.
 *
 * @returns {string} - The LayoutProvider template.
 */
export const ProviderLayoutTemplate = () =>
  `
